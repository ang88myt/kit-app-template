...
class CustomInfoWidget:
    ...
    def __init__(self, label: str, placeholder: str, btn_callback: Optional[Callable] = None):
        self.__label = label
    ...
    def _build_fn(self):
        ...
        with ui.HStack():
            ...
            # Use placeholder text instead of default
            self.__input_field = ui.StringField(
                name="input_field",
                placeholder=self.__placeholder,  # Correct usage of placeholder text
                height=BLOCK_HEIGHT,
                width=ui.Fraction(2),
            )
            ...
            self.__btn = ui.Button(
                ...
                height=BLOCK_HEIGHT,
                width=ui.Fraction(1),
                clicked_fn=self._button_callback  # Correctly pass the callback function
            )
