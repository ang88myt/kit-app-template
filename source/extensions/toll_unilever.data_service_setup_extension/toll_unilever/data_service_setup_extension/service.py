...
router = ServiceAPIRouter(tags=["Dataservice Setup Extension"])
...
async def generate_cube(cube_data: CubeDataModel):
    print("[toll_unilever.data_service_setup_extension] generate_cube was called")
    ...
    msg = f"[toll_unilever.data_service_setup_extension] Wrote a cube to this path: {asset_file_path}"
    print(msg)
    return msg
